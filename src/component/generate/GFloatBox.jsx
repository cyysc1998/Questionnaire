        ...
        return (
            ...
            >
               <div style={{width: '80%', textAlign: 'center', margin: '0 auto'}}>
                    ...
                    <Input placeholder="最小值" style={{ width: '15.2%'}} onChange={this.onIntroChange}/> &nbsp;
                    <Input placeholder="最大值" style={{ width: '15.2%'}} onChange={this.onIntroChange}/> &nbsp;
                    <Input placeholder="步长" style={{ width: '15.2%'}} onChange={this.onIntroChange}/>   &nbsp;
                    <Input placeholder="精度" style={{ width: '15.2%'}} onChange={this.onIntroChange}/>   &nbsp;
                    <br/>
                </div>
            </Card>
        );
